 ...
 */
package com.raven.seachtextfield;
...
public class TextFieldAnimation extends JTextField{
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/com/raven/seachtextfield/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/com/raven/seachtextfield/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/com/raven/seachtextfield/loading.gif"));
